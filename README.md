...
[![Release](https://img.shields.io/github/v/release/latest-debs/uncloud-debian)](https://github.com/latest-debs/uncloud-debian/releases)
[![Build](https://github.com/latest-debs/uncloud-debian/actions/workflows/release.yml/badge.svg)](../../actions)

Lightweight clustering and container orchestration tool — packaged for Debian as part of [latest-debs](https://github.com/latest-debs).
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/uncloud-debian/releases) page:

```sh
sudo apt install ./uncloud_*.deb
```

## Verify

```sh
apt-cache policy uncloud
uncloud --version
```
...
Run the [Build uncloud for Debian](../../actions) workflow on GitHub with the
...
For issues with uncloud itself, see
